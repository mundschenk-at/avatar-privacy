...
namespace Avatar_Privacy\Default_Icons\Generator\Jdenticon\Shapes\Outer;
...
class Triangle implements Shape {
	 ...
	 *
	 * @param int $corner The corner orientation.
	 */
	public function __construct( $corner = 0 ) {
		$this->corner = $corner;
	}
	...
	public function render( Context $graphics, $cell, $index ) {
		$graphics->add_triangle( new Point( 0, 0 ), $cell, $cell, $this->corner );
	}
}
