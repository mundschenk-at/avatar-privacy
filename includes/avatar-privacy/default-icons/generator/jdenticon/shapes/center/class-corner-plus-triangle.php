 ...
 * A center shape.
 */
class Corner_Plus_Triangle implements Shape {
	...
	public function render( Context $graphics, $cell, $index ) {
		$graphics->add_rectangle( new Point( 0, 0 ), $cell, $cell / 2 );
		$graphics->add_rectangle( new Point( 0, $cell / 2 ), $cell / 2, $cell / 2 );
		$graphics->add_triangle( new Point( $cell / 2, $cell / 2 ), $cell / 2, $cell / 2, 1 );
	}
}
