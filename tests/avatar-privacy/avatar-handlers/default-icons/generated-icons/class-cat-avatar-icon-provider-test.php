...
use Avatar_Privacy\Avatar_Handlers\Default_Icons\Generated_Icons\Cat_Avatar_Icon_Provider;

use Avatar_Privacy\Avatar_Handlers\Default_Icons\Generators;
use Avatar_Privacy\Data_Storage\Filesystem_Cache;

/**
 * Avatar_Privacy\Avatar_Handlers\Default_Icons\Generated_Icons\Cat_Avatar_Icon_Provider unit test.
 *
 * @coversDefaultClass \Avatar_Privacy\Avatar_Handlers\Default_Icons\Generated_Icons\Cat_Avatar_Icon_Provider
 * @usesDefaultClass \Avatar_Privacy\Avatar_Handlers\Default_Icons\Generated_Icons\Cat_Avatar_Icon_Provider
 *
 * @uses ::__construct
 */
class Cat_Avatar_Icon_Provider_Test extends \Avatar_Privacy\Tests\TestCase {
	...
	public function test_constructor() {
		$generator  = m::mock( Generators\Cat_Avatar::class );
	...
	public function test_get_filename() {
		...
		$this->assertSame( "cat/{$path}/{$identity}-{$size}.png", $sut->get_filename( $identity, $size ) );
	}
